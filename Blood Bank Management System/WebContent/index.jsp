...
<body>
 ...
 if("valid".equals(msg)){
	 %>
	 <center><font color="green" size="5">Form Submitted Successfully. You will get notefied in 24 hours</font></center>
 	<%
 } 
 %>
...
<center><h1>Enter your Details to Request to Blood</h1></center>
...
<h3><center>All Right Reserved @ Devraj Chavan :: 2023  </center></h3>
